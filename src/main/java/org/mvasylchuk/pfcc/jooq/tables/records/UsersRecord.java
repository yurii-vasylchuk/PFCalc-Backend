...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record9<Long, String, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal, Byte, Byte> {
    ...
    @Override
    public Row9<Long, String, String, BigDecimal, BigDecimal, BigDecimal, BigDecimal, Byte, Byte> valuesRow() {
    ...
    @Override
    public UsersRecord values(Long value1, String value2, String value3, BigDecimal value4, BigDecimal value5, BigDecimal value6, BigDecimal value7, Byte value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersRecord(Long id, String email, String preferredLanguage, BigDecimal proteinAim, BigDecimal fatAim, BigDecimal carbohydratesAim, BigDecimal caloriesAim, Byte profileConfigured, Byte emailConfirmed) {
        super(Users.USERS);
