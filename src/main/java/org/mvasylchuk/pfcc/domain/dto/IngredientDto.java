...
public class IngredientDto extends FoodDto {
    ...
    public IngredientDto(long id, String name, String description, Pfcc pfcc, Boolean isHidden, FoodType foodType, Boolean ownedByUser, List<IngredientDto> ingredients, BigDecimal ingredientWeight) {
